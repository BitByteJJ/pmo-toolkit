...
var SYSTEM_PROMPT = `You are a senior project management educator writing engaging, practical deep-dive content for project managers.
...
async function handleAiDeepDive(req, res) {
  if (req.method !== "POST") {
