...
## Voice & AI Fix — Feb 2026
- [x] Fix Maya voice: Studio-O (female) — was incorrectly using Journey-D (male)
- [x] Fix Chris voice: Studio-Q (male) — was incorrectly using Journey-O (female)
- [x] All 5 characters now have distinct, gender-correct voices (Journey-D, Journey-O, Journey-F, Studio-O, Studio-Q)
- [x] Improve AI tool suggestion: upgraded system prompt with consultant persona, specific action guidance, 2-3 sentence reasons
- [x] AI suggestion token limit raised to 1200 for richer explanations, timeout raised to 30s
- [x] AI summary text colour fixed for dark mode (indigo-900 → rgba-safe)
- [x] "Listen to episode" shortcut button added to each recommendation card in AiSuggest page
- [x] 5 new vitest tests for voice gender correctness and distinct voice uniqueness (101 total, all passing)
